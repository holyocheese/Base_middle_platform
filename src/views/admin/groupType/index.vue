...
<div class="app-container calendar-list-container">
  ...
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%; font-size:12px;">
    <el-table-column align="center" label="id" width="50"> <template slot-scope="scope">
                  <span>
                    {{scope.row.id}}
                  </span>
</template>
      </el-table-column>
      <el-table-column width="120px" align="left" label="编码">
<template slot-scope="scope">
<span>{{scope.row.code}}</span>
</template>

    </el-table-column>
        <el-table-column align="left" width="120px" label="类型名称">
          <template slot-scope="scope">
  <span>
                {{scope.row.name}}</span>
</template>
    ...
    <el-table-column width="300px" label="描述">
<template slot-scope="scope">
<span>
        ...
        <el-table-column align="center" label="最后更新时间"><template slot-scope="scope">
  <span>
  ...
  <span>
        ...
        <el-table-column align="center" label="最后更新主机"><template slot-scope="scope">
  <span>
