<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="测试内容" v-model="listQuery.name"> </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading"  @current-change="handleDataCurrentChange" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column width="200px" align="center" label="测试编码">
...
<script>
import { page, addObj, getObj, delObj, putObj,test } from 'api/auth/service/index';
