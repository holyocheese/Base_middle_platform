    ...
    <template v-if="mode === 'transfer'">
      ...
      <div class="transfer-left">
        ...
        <div class="transfer-main">
          <!-- <slot name="from"></slot> -->
          <el-input v-if="filter" :placeholder= "placeholderArr[0]" v-model="filterFrom" size="small" class="filter-tree">
          </el-input>
      ...
      <div class="transfer-right">
        ...
        <div class="transfer-main">
          <!-- <slot name='to'></slot> -->
          <el-input v-if="filter" :placeholder="placeholderArr[1]" v-model="filterTo" size="small" class="filter-tree">
          </el-input>
      ...
      <div class="transfer-right">
        <div class="transfer-right-item" :class="{'transfer-right-small':move_up}">
          ...
          <div class="transfer-main" v-if='!move_up'>
            <!-- <slot name='to'></slot> -->
            <el-input v-if="filter" :placeholder="placeholderArr[1]" v-model="filterListFirst" size="small" class="filter-tree">
            </el-input>
        ...
        <div class="transfer-right-item">
          ...
          <div class="transfer-main">
            <!-- <slot name='to'></slot> -->
            <el-input v-if="filter" :placeholder="placeholderArr[0]" v-model="filterListSecond" size="small" class="filter-tree">
            </el-input>
            <ul class="address-list-ul">
        ...
        <div class="transfer-right-item" :class="{'transfer-right-small':!move_up}">
          ...
          <div class="transfer-main" v-if='move_up'>
            <!-- <slot name='to'></slot> -->
            <el-input v-if="filter" :placeholder="placeholderArr[1]" v-model="filterListThird" size="small" class="filter-tree">
            </el-input>
            <ul class="address-list-ul">
...
export default {
  ...
  methods: {
    ...
    addToAims() {
      ...
      // 选中节点数据
      const arrayCheckedNodes = this.$refs['from-tree'].getCheckedNodes(
        this.leafOnly
      );
      ...
      // 第二步
      const cloneSkeletonCheckedNodes = JSON.parse(
    ...
    addressListTransfer(type) {
      // 获取选中通过穿梭框的keys - 仅用于传送纯净的id数组到父组件同后台通信
      const keys = this.$refs['from-tree'].getCheckedKeys(true);
      // 选中节点数据
      const arrayCheckedNodes = this.$refs['from-tree'].getCheckedNodes(true);
      // 去重筛选
  ...
  computed: {
    // 左侧数据
    self_from_data() {
      const from_array = [...this.from_data, ...this.self_from];
    ...
    // 右侧数据
    self_to_data() {
      const to_array = [...this.to_data, ...this.self_to];
